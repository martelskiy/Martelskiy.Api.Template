...
namespace Martelskiy.Api.Template.Features.Shared.ErrorHandling
{
    public class ErrorHandlingMiddleware : IMiddleware
    {
        ...
        public ErrorHandlingMiddleware(ISerializer serializer, ILogger<ErrorHandlingMiddleware> logger)
        {
        ...
        public async Task InvokeAsync(HttpContext context, RequestDelegate next)
        {
            ...
            catch (Exception exception)
            {
                ...
                await context.Response.WriteAsync(_serializer.Serialize(problemDetails));
            }
        }
